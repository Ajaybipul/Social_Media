    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="bg-white p-4 rounded-lg shadow-lg w-80">
        ...
        <div className="flex flex-col space-y-2">
          ...
          <a
            href={`https://www.reddit.com/submit?url=${postUrl}`}
            target="_blank"
            rel="noopener noreferrer"
...
const PostCard = ({ type, value }) => {
  ...
  const postUrl = `${window.location.origin}/post/${value._id}`;
  ...
  return (
    <div className="bg-gray-100 flex items-center justify-center pt-3 pb-14">
      ...
      <SimpleModal isOpen={showModal} onClose={() => setShowModal(false)}>
        <LikeModal isOpen={openLikes} onClose={() => setOpenLikes(false)} id={value._id} />
